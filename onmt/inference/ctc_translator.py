...
class CTCTranslator(Translator):
    ...
    def _translateBatch(self, batch):
        ...
        if False:
            #  (3) Start decoding
            # TODO: test generate a matrix of vocab size x encoder length
            ...
            # TODO: different from using with a decoder: no decoder state; not using EOS;
            # blank=onmt.constants.PAD
            ...
            # Start decoding
            for step in range(max_len + 1):  # one extra step for EOS marker    # TODO: no extra 1
                ...
                # TODO: remove checking repeated n gram
